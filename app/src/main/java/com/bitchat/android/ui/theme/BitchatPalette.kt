...
data class BitchatPalette(
    ...
    // MARK: - Messenger surfaces
    /** Fill of a bubble you sent. */
    val bubbleOutgoing: Color,
    /** Fill of a bubble someone else sent. */
    val bubbleIncoming: Color,
    /** Hairline around a bubble. Barely there; the fill does the work. */
    val bubbleOutline: Color,
    /** The chat transcript's own ground, distinct from the app bar surface. */
    val chatWallpaper: Color,
    /** Read receipts. Blue, the way every messenger has trained people to read it. */
    val tickRead: Color,
    /** Date separators and the encryption notice that sit on the wallpaper. */
    val chatChipSurface: Color,
...
val DarkBitchatPalette = BitchatPalette(
    ...
    bubbleOutgoing = Color(0xFF005C4B),
    bubbleIncoming = Color(0xFF202C33),
    bubbleOutline = Color(0x14FFFFFF),
    chatWallpaper = Color(0xFF0B141A),
    tickRead = Color(0xFF53BDEB),
    chatChipSurface = Color(0xFF182229),
...
val LightBitchatPalette = BitchatPalette(
    ...
    bubbleOutgoing = Color(0xFFD9FDD3),
    bubbleIncoming = Color(0xFFFFFFFF),
    bubbleOutline = Color(0x0D000000),
    chatWallpaper = Color(0xFFEFE7DE),
    tickRead = Color(0xFF34B7F1),
    chatChipSurface = Color(0xFFE8E3DB),
