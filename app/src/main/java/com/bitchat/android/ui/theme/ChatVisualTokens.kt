 ...
 */
internal val BitchatFontFamily = FontFamily.Default

/**
 * The bundled Geist Mono family, kept for the few surfaces that genuinely want a fixed
 * advance width (hex fingerprints, geohash codes, peer IDs). The chat surface itself uses
 * the platform sans family above so the app reads like a messenger rather than a terminal.
 */
internal val BitchatMonoFontFamily = FontFamily(
...
internal object ChatVisualTokens {
    ...
    val MessageBodyLineHeight: TextUnit = 21.sp
